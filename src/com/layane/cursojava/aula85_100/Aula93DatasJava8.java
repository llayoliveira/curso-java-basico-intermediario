...
public class Aula93DatasJava8 {
	...
	public static void main(String[] args) {
		...
		System.out.println(LocalDate.parse("2020-02-11"));
		...
		System.out.println(LocalDate.parse("2020-02-11").isLeapYear());
		...
		System.out.println(LocalDateTime.parse("2022-03-18T13:57:03.363415400"));
		...
		ZonedDateTime zdt = ZonedDateTime.of(LocalDateTime.parse("2022-03-18T13:57:03.363415400"),  sp);
		System.out.println(zdt);
		System.out.println(ZonedDateTime.parse("2022-03-18T13:57:03.363415400-03:00[America/Sao_Paulo]"));
